            ...
            <>
              ...
              {showScrollToBottom && (
                <button
                  ...
                  className="absolute bottom-24 left-1/2 z-20 flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--text-primary)] shadow-lg transition hover:bg-[var(--surface-hover)]"
                >
                  <ArrowDown size={18} />
                </button>
              )}
